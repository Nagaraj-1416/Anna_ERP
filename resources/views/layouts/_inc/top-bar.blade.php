            ...
            <ul class="navbar-nav mr-auto mt-md-0">
                ...
                <li class="nav-item hidden-sm-down search-box">
                    <a class="nav-link hidden-sm-down text-muted waves-effect waves-dark" href="javascript:void(0)"><i
                                class="ti-search"></i></a>
                    <form class="app-search" action="{{ route('search.result') }}" method="get">
                        <input type="text" class="form-control" placeholder="Search & enter"
                               name="keyword"
                               value="{{ (isset($_GET['keyword'])  && $_GET['keyword'] != null) ? $_GET['keyword'] : '' }}">
                        <a class="srh-btn">
                            <i class="ti-close"></i>
                        </a>
                    </form>
                    ...
                    <ul>
                        ...
                        <li>
                            <div class="message-center">
                                <!-- Message -->
                                <a href="#">
                                    <div class="user-img"> <img src="{{ asset('images/users/1.jpg') }}" alt="user" class="img-circle">
                                ...
                                <!-- Message -->
                                <a href="#">
                                    <div class="user-img"> <img src="{{ asset('images/users/2.jpg') }}" alt="user" class="img-circle">
                                ...
                                <!-- Message -->
                                <a href="#">
                                    <div class="user-img"> <img src="{{ asset('images/users/3.jpg') }}" alt="user" class="img-circle">
                                ...
                                <!-- Message -->
                                <a href="#">
                                    <div class="user-img"> <img src="{{ asset('images/users/4.jpg') }}" alt="user" class="img-circle">
                ...
                <li class="nav-item dropdown">
                    <a class="nav-link dropdown-toggle text-muted waves-effect waves-dark" href=""
                       data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                        <img src="{{route('setting.staff.image', [auth()->user()->staffs->first()])}}" alt="user"
                             class="profile-pic"/>
                    </a>
                        ...
                        <ul class="dropdown-user">
                            <li>
                                <div class="dw-user-box">
                                    <div class="u-img"><img
                                                src="{{route('setting.staff.image', [auth()->user()->staffs->first()])}}"
                                                alt="user"></div>
                                    <div class="u-text">
                                        ...
                                        @can('loginAs' ,auth()->user())
                                            <a class="btn btn-rounded btn-danger btn-sm login-as-sidebar-btn">Login
                                                As</a>
                                        @endcan
                                    </div>
                                </div>
