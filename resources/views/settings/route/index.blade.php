            ...
            <div class="card">
                ...
                <div class="contact-page-aside">
                    ...
                    <div class="left-aside">
                        <a target="_blank" href="{{ route('setting.route.create') }}" class="btn btn-info btn-block">
                    ...
                    <div class="right-aside custom-right-aside">
                        <div class="right-page-header">
                            <div class="d-flex m-b-10">
                                <div class="align-self-center">
                                    <h2 class="card-title m-t-10">Routes @{{ total ? ("(" + total +")") :
                                        '' }}</h2>
                                </div>
                                <div class="ml-auto">
                                    <input type="text" id="demo-input-search2" ng-model="searchRoutes"
                                           placeholder="search for route here" class="form-control"
                        ...
                        <div class="row" ng-hide="loading">
                            <div class="col-md-12 m-b-20">
                                <table class="table m-t-10 table-hover no-wrap contact-list">
                                    ...
                                    <tr>
                                        <th colspan="3">Route details</th>
                                    </tr>
                                    </thead>
                                    <tbody>
                                    <tr ng-repeat="route in routes">
                                        <td>
                                            <a target="_blank" href="/setting/route/@{{ route.id }}">
                                                @{{ route.name }}
                                            </a>
                                        </td>
                                        ...
                                        <td class="text-right">
                                            ...
                                            <small class="text-muted">
                                                <b>Locations </b>: @{{ route.locations.length }}
                                            </small>
                                        </td>
                                    </tr>
                                    </tbody>
                        ...
                        <div class="row" ng-hide="loading" ng-if="routes.length === 0 && !filterd">
                            <div class="col-md-12">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <p class="card-text">You haven't added any route yet, click on "Add New Route"
                                            button to add route.</p>
                                        <a target="_blank" href="{{ route('setting.route.create') }}"
                                           class="btn btn-info">
                                            <i class="fa fa-plus"></i> Add New Route
                                        </a>
                                    </div>
                        ...
                        <div class="row" ng-hide="loading" ng-if="routes.length === 0 && filterd">
                            <div class="col-md-12">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <p class="card-text">There are <code>no</code> routes found.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    <script>
        app.controller('RouteController', ['$scope', '$http', function ($scope, $http) {
            var moduleRoute = '{{ route('setting.route.index') }}';
            $scope.routes = [];
            $scope.filterd = false;
            $scope.loading = true;
            $scope.pagination = {};
            ...
            $scope.filterUpdated = function () {
                $scope.filterd = true;
                $scope.query.search = $scope.searchRoutes;
                $scope.fetchRoutes();
            };
