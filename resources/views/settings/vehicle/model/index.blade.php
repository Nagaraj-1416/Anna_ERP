...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @can('create', new \App\VehicleModel())
                        <a href="{{ route('setting.vehicle.model.create') }}" class="btn btn-info"> <i
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $table.DataTable({
                ...
                "orderCellsTop": true,
                "ajax": {
                    "url": "{{ route('setting.vehicle.model.table.data') }}",
                    "dataType": "json",
                    "type": "POST",
        ...
        $('.card-body').on('click', '.delete-vehicle-model', function () {
            var id = $(this).data('id');
            var deleteUrl = '{{ route('setting.vehicle.model.delete', [ 'vehicleType'=>'ID']) }}';
