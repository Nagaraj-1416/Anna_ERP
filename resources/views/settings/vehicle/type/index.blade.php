...
@section('content')
    <div class="row">
        <div class="col-12">
            <div class="card">
                <div class="card-body">
                    @can('create', new \App\VehicleType())
                        <a href="{{ route('setting.vehicle.type.create') }}" class="btn btn-info"> <i
    ...
    <script>
        $(document).ready(function () {
            ...
            var table = $table.DataTable({
                ...
                "orderCellsTop": true,
                "ajax": {
                    "url": "{{ route('setting.vehicle.type.table.data') }}",
                    "dataType": "json",
                    "type": "POST",
        ...
        $('.card-body').on('click', '.delete-vehicle-type', function () {
            var id = $(this).data('id');
            var deleteUrl = '{{ route('setting.vehicle.type.delete', [ 'vehicleType'=>'ID']) }}';
