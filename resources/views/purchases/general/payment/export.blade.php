    ...
    <div style="padding-top: 15px;">
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr style="background-color: #2f3d4a;">
                ...
                <th style="text-align: center;color: #fff;width: 100px;">Type</th>
                <th style="text-align: center;color: #fff;width: 100px;">Mode</th>
                <th style="text-align: center;color: #fff;width: 100px;">Prepared By</th>
            ...
            <tr>
                ...
                <td style="vertical-align: top;text-align: center;">{{ $payment->payment_type }}</td>
                <td style="vertical-align: top;text-align: center;">{{ $payment->payment_mode }}</td>
                <td style="vertical-align: top;text-align: center;">{{ $payment->preparedBy->name or 'None'}}</td>
                <td style="vertical-align: top;text-align: center;">{{  $payment->status }}</td>
