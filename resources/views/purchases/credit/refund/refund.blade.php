<div ng-controller="RefundController">
                        ...
                        @foreach($credit->refunds()->get() as $refund)
                            <tr>
                                ...
                                <td>
                                    ...
                                    @can('print', $refund)
                                        <a target="_blank"
                                           href="{{ route('purchase.credit.refund.print', ['credit' => $credit, 'refund' => $refund]) }}"
    ...
    <div id="refund-sidebar" class="card card-outline-info disabled-dev">
            ...
            <div class="form">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group  required" ng-class="hasError('refunded_to') ? 'has-danger' : ''">
                                <label for="mobile" class="control-label form-control-label">Refunded to</label>
                                <div class="ui fluid selection dropdown refunded-from-dropdown">
                                    <input type="hidden" name="refunded_to">
                                    <i class="dropdown icon"></i>
                                ...
                                <p class="form-control-feedback">@{{ getErrorMsg('refunded_to') }}</p>
                            </div>
                        </div>
                    </div>
                    {{--cheque data--}}
...
@section('script')
    @parent
    @include('purchases.credit.refund._inc.script')
@endsection