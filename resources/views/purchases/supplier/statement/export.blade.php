...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Supplier Statement ('.$supplier->code.')' }}</title>
...
<div style="font-family: sans-serif;font-size: 12px;" id="supplier">
                    ...
                    <div style="font-family: sans-serif; padding-top: 15px;">
                        ...
                        <table style="font-family: sans-serif;border-collapse: collapse;font-size: 12px;">
                            <tr>
                                ...
                                <td style="width: 50%; text-align: right;">{{ number_format(supCreditOutstanding($supplier)['credits'], 2) }}</td>
                            </tr>
                            <tr>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr>
                ...
                <td style="width:15%;text-align: right;border-top: 1px solid #D0D0D0;">
                    <strong>{{ number_format(supOutstanding($supplier)['ordered'], 2) }}</strong>
                </td>
                <td style="width:15%;text-align: right;border-top: 1px solid #D0D0D0;">
                    <strong>{{ number_format(supOutstanding($supplier)['billed'], 2) }}</strong>
                </td>
                <td style="width:15%;text-align: right;border-top: 1px solid #D0D0D0;">
                    <strong>{{ number_format(supOutstanding($supplier)['paid'], 2) }}</strong>
                </td>
                <td style="width:15%;text-align: right;padding-right: 10px;border-top: 1px solid #D0D0D0;">
                    <strong>{{ number_format(supOutstanding($supplier)['balance'], 2) }}</strong>
                </td>
            </tr>
            </tbody>
        </table>
    ...
    <!-- bills panel -->
    <div>
        <h4 style="font-weight: 600;font-family: sans-serif;font-size: 15px;"><b>Bills</b></h4>
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            <thead>
            <tr style="background-color: #2f3d4a;">
                <th style="height: 35px;width: 5%;color: #fff;text-align: left;padding-left: 10px;">#</th>
                <th style="color: #fff;text-align: left;width: 10%;">Bill no</th>
            ...
            @if(count($bills))
                @foreach($bills as $billKey => $bill)
                    <tr>
                        <td style="height: 35px;width: 5%;text-align: left;vertical-align: middle;padding-left: 10px;">{{ ($billKey+1) }}</td>
                        <td style="vertical-align: middle;">
                            {{ $bill->bill_no }}
                        </td>
    ...
    <div>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr>
                ...
                <td style="width:15%;text-align: right;padding-right: 10px;border-top: 1px solid #D0D0D0;">
                    <strong>{{ number_format(supCreditOutstanding($supplier)['balance'], 2) }}</strong>
                </td>
            </tr>
            </tbody>
        </table>
