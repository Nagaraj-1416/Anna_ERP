<div ng-controller="InvoiceController">
    @if($credit->payments()->count())
        <div class="card">
            <div class="card-body">
                <h3><b>INVOICES CREDITED</b> <span
                            class="pull-right">Total Invoices Credited: {{ $credit->payments()->count() }}</span>
                </h3>
                <hr>
                        ...
                        @foreach($credit->payments()->get() as $payment)
                            <tr>
                                ...
                                <td>
                                    ...
                                    <a target="_blank"
                                       href="{{ route('sales.payment.print', ['credit' => $credit, 'payment' => $payment]) }}"
    ...
    <div id="invoice-sidebar" class="card card-outline-inverse disabled-dev">
            ...
            <div class="form">
                <div class="form-body">
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-12">
                            <div class="form-group required" ng-class="hasError('account') ? 'has-danger' : ''">
                                <label for="payment_type" class="control-label form-control-label">Deposited To</label>
                                ...
                                <p class="form-control-feedback">@{{ getErrorMsg('account') }}</p>
                            </div>
                        </div>
                        <div class="col-md-12">
