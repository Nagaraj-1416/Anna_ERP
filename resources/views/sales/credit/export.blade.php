...
<head>
    ...
    <title>{{ env('APP_NAME').' | Customer Credit ('.$credit->code.')' }}</title>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="left">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">CUSTOMER CREDIT</span>
                </td>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr>
                ...
                <td style="text-align: right;font-weight: 700;height: 25px;padding-right: 10px;">
                    <strong>{{ number_format(getCustomerCreditLimit($credit), 2) }}</strong>
                </td>
            </tr>
        </table>
    </div>
