...
<head>
    ...
    <title>{{ env('APP_NAME').' | Customer Credit Refund Receipt' }}</title>
    ...
    <div style="padding-top: 15px;">
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr style="background-color: #2f3d4a;">
                ...
                <th style="text-align: left;color: #fff;width: 100px;">Paid through</th>
            ...
            <tr>
                ...
                <td style="vertical-align: top;text-align: left;">{{ $refund->payment_mode }}</td>
                <td style="vertical-align: top;text-align: left;">{{ $refund->account->name ?? 'None'}}</td>
                <td style="vertical-align: top;text-align: left;">{{  $refund->status }}</td>
