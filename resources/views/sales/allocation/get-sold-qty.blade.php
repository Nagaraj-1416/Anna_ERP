        ...
        <div class="col-12">
            <div class="card card-outline-primary">
                <div class="card-header">
                    <h3 class="text-white">Sold Qty Details</h3>
                </div>
                <div class="card-body">
                    {!! form()->model($allocation, ['url' => route('sales.allocation.update.sold.qty', $allocation), 'method' => 'PATCH', 'enctype' => 'multipart/form-data']) !!}
                    <div class="form-body">
                        <div class="row">
                            <div class="col-md-4">
                    ...
                    <hr>
                    {!! form()->bsSubmit('Update', 'btn btn-success waves-effect waves-light m-r-10', 'Update', 'submit') !!}
