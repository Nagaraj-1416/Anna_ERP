<div class="form-body">
    ...
    <div class="row">
        <div class="col-md-3">
            <div class="form-group required {{ $errors->has('sales_location') ? 'has-danger' : '' }}">
                <label class="control-label">Allocate for Van / Shop?</label>
                <div class="demo-radio-button">
        ...
        <div class="col-md-3" ng-show="query.locationType === 'Shop'">
            <div class="form-group required {{ $errors->has('store_id') ? 'has-danger' : '' }}">
                <label class="control-label">Store</label>
                <div class="ui fluid search normal selection dropdown store-drop-down {{ $errors->has('store_id') ? 'error' : '' }}">
    ...
    <hr ng-show="query.locationType === 'Van'">

    <div class="van-products" ng-show="query.locationType === 'Van'">
        <div class="pull-left">
            <h4 class="box-title">Allocated products by Store Keeper
        ...
        <div class="pull-right">
            <h4 class="box-title text-warning">Total Products : @{{ products.length }}
            </h4>
        </div>
        <div class="clrearfix">
        ...
        <div id="product-section">
            <table id="demo-foo-addrow" class="table no-wrap contact-list table-scroll"
                   data-page-size="10">
                <thead>
                <tr>
                    <th style="width: 10%;">Product details</th>
                    <th style="width: 10%;" class="text-center table-primary">Required quantity</th>
                    <th style="width: 10%;" class="text-center table-warning">CF quantity</th>
                    <th style="width: 10%;" class="text-center table-danger">Issued quantity</th>
                    <th style="width: 10%;" class="text-center table-success">Total allocation</th>
                </tr>
                </thead>
                <tbody>
                <tr ng-repeat="(key, product) in products | filter:productSearch" product-directive
                    ...
                    <td style="width: 10%;" class="text-center td-bg-info text-info">
                        @{{ product.default_qty }}
                    </td>
                    <td style="width: 10%;" class="text-center td-bg-warning text-warning">
                        @{{ product.available_qty ? product.available_qty : 0 }}
                    </td>
                    <td style="width: 10%;" class="text-center td-bg-danger text-danger">
                        @{{ product.issued_qty ? product.issued_qty : 0 }}
                    </td>
                    <td style="width: 10%;" class="text-center td-bg-success text-green">
                        @{{ product.available_qty + product.issued_qty }}
                    </td>
                </tr>
        ...
        <div id="product-section">
            <table class="ui table bordered celled striped table-scroll">
                ...
                <tr>
                    ...
                    {{--<th style="width: 20%;">Default Qty</th>--}}
                    <th style="width: 20%;">CF Qty</th>
                    <th style="width: 20%;">Issue Qty</th>
                </tr>
                </thead>
                <tbody>
                <tr ng-repeat="(key, product) in products | filter:productSearch" product-directive
                    ...
                    <td style="width: 20%;" class="text-right">
                        <input type="text" class="form-control" name="product[cf][@{{ product.id }}]"
