    ...
    <div class="card-body">
        ...
        <div class="table-responsive">
            <table class="table color-table muted-table">
                ...
                <tbody>
                <tr ng-show="credits.length" dir-paginate="credit in credits | itemsPerPage:5" pagination-id="credits_pagination">
                    <td>
                        <a target="_blank" href="/sales/credit/@{{ credit.id }}">@{{ credit.code }}</a>
                    </td>
                    <td>@{{ credit.date }}</td>
                    <td>
                    ...
                    <td class="text-right text-warning">@{{ getCustomerCreditLimit(credit) | number:2 }}</td>
                </tr>
