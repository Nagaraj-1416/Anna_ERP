...
<head>
    ...
    <title>{{ env('APP_NAME').' | Invoice ('.$invoice->invoice_no.')' }}</title>
    <meta charset="iso-8859-1">
</head>
<body>
<!-- pdf full panel -->
<div style="font-family: sans-serif;font-size: 12px;" id="invoice">

    <div>
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="left">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">INVOICE</span>
                </td>
                <td style="width: 50%;font-family: sans-serif;" align="right">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">#{{ $invoice->invoice_no ?? '' }}</span>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="padding-top: 15px;">
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr style="background-color: #2f3d4a;">
                <th style="height: 35px;padding-left: 10px;color: #fff;text-align: left;">Invoice Date</th>
                <th style="color: #fff;text-align: left;">Due Date</th>
                <th style="color: #fff;text-align: left;">Prepared by</th>
                <th style="text-align: right;color: #fff;padding-right: 10px;">Amount</th>
            </tr>
            </thead>
            <tbody>
            <tr>
                <td style="vertical-align: middle;text-align: left;padding-left: 10px;">{{ $invoice->invoice_date }}</td>
                <td style="vertical-align: middle;text-align: left;">{{ $invoice->due_date }}</td>
                <td style="vertical-align: middle;text-align: left;">{{ $invoice->preparedBy->name or 'None' }}</td>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr>
                ...
                <td style="text-align: right;font-weight: 700;height: 25px;padding-right: 10px;">
                    <strong>{{ number_format(invOutstanding($invoice)['balance'], 2) }}</strong>
                </td>
            </tr>
        </table>
    </div>
    ...
    <div style="margin-top: 20px;">
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td>
                    Notes<br/>
                    <span style="font-size: 10px;color: #818181">{{ $invoice->notes }}</span>
                </td>
            </tr>
        </table>
    </div>
