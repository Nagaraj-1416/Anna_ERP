...
<head>
    ...
    <title>{{ env('APP_NAME').' | Cash Shortage ('.$route->name.')' }}</title>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="left">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">CASH SHORTAGE</span>
                </td>
                <td style="width: 50%;font-family: sans-serif;" align="right">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">AMOUNT: {{ number_format($shortage->amount, 2) }}</span>
                </td>
            </tr>
        </table>
    </div>
