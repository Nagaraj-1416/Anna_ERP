...
@section('title', 'Shortage Stocks')
@section('breadcrumbs')
    {!! breadcrumbRender($breadcrumb, 'Sales') !!}
@endsection
@section('content')
    <div class="row" ng-controller="StockShortageController">
        <div class="col-12">
            <div class="card">
                        ...
                        <div class="right-page-header">
                            <div class="d-flex m-b-10">
                                <div class="align-self-center">
                                    <h2 class="card-title m-t-10">Shortage Stocks @{{ total ? ("(" + total
                                        +")") :
                                        '' }}</h2>
                                </div>
                                ...
                                <table id="demo-foo-addrow" class="table m-t-10 table-hover no-wrap contact-list"
                                    ...
                                    <tr ng-repeat="stock in stocks">
                                        <td>
                                            ...
                                            <a target="_blank" href="/sales/stock-shortage/@{{ stock.id }}">View Details</a>
                                        </td>
                                        <td>
                                            @{{ stock.notes }}<br />
                        ...
                        <div class="row" ng-hide="loading" ng-if="stocks.length === 0 && filterd">
                            <div class="col-md-12">
                                <div class="card text-center">
                                    <div class="card-body">
                                        <p class="card-text">There are <code>no</code> shortage stocks found.</p>
                                    </div>
                                </div>
                            </div>
                        </div>
...
@section('script')
    ...
    <script>
        app.controller('StockShortageController', ['$scope', '$http', function ($scope, $http) {
            var moduleRoute = '{{ route('sales.stock.shortage.index') }}';
            $scope.stocks = [];
            $scope.filterd = false;
            $scope.loading = true;
            $scope.pagination = {};
