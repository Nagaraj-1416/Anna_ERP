        ...
        <div class="col-md-12">
            <div class="card card-outline-inverse">
                <div class="card-header">
                    <h4 class="m-b-0 text-white">Stock Shortage Details</h4>
                </div>
                <div class="card-body">
                    <div class="clearfix">
                        <div class="pull-left">
                            <a href="{{ route('sales.stock.shortage.export', [$stock]) }}"
                    ...
                    <div class="row custom-top-margin">
                                                        ...
                                                        <tr>
                                                            ...
                                                            <td class="text-center">
                                                                @if($item->status == 'Drafted')
                                                                    <a target="_blank" class="btn btn-success btn-xs" href="{{ route('sales.stock.shortage.approve', [$stock, $item]) }}">
                                                                        <i class="fa fa-check"></i> Approve
                                                                    </a>
                                                                    <a target="_blank" class="btn btn-danger btn-xs" href="{{ route('sales.stock.shortage.reject', [$stock, $item]) }}">
                        ...
                        <div class="col-md-3">
                            ...
                            <div class="card">
                                <div class="card-body">
                                    @include('general.log.index', ['model' => $stock, 'modelName' => 'Shortage Stock'])
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    ...
    <script>
        $(document).ready(function () {
            ...
            var approveRoute = '';
            var rejectRoute = '';
            var showRoute = '{{ route('sales.stock.shortage.show', $stock) }}';

            $approveBtn.click(function (e) {
                e.preventDefault();
                Swal({
                    title: 'Are you sure?',
                    text: "You won't be able to revert this action! Are you sure want to approve the shortage stock list?",
                    type: 'warning',
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success){
                                    Swal(
                                        'Mark as Approved!',
                                        'This shortage stock list is approved successfully!',
                                        'success'
                                    );
                                    setTimeout(function () {
            ...
            $rejectBtn.click(function (e) {
                ...
                Swal({
                    title: 'Are you sure?',
                    text: "You won't be able to revert this action! Are you sure want to reject the shortage stock list?",
                    type: 'warning',
                    showCancelButton: true,
                        ...
                        $.ajax({
                            ...
                            success: function(response) {
                                if (response.success){
                                    Swal(
                                        'Mark as Rejected!',
                                        'This shortage stock list is rejected successfully!',
                                        'success'
                                    );
                                    setTimeout(function () {
                                        window.location.href = showRoute;
