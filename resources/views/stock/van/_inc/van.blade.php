<div class="row" ng-show="location">
    <div class="col-md-12">
        <div class="ribbon-wrapper card">
            <div class="ribbon ribbon-default">@{{ location.name }}</div>
            <div class="row">
                <div class="col-md-12">
                    <div class="cardScroll">
                        <table class="table table-scroll">
                            ...
                            <tr>
                                ...
                                <th class="text-center table-danger">EXCESS QTY</th>
                            ...
                            <tr ng-repeat="item in items">
                                ...
                                <td class="text-center">@{{ item.excess_qty ? item.excess_qty : 0 }}</td>
                                <td class="text-center">@{{ item.restored_qty ? item.restored_qty : 0 }}</td>
                                <td class="text-center">
                                    @{{ (item.quantity + item.cf_qty + item.returned_qty + item.excess_qty) - (item.sold_qty + item.restored_qty + item.replaced_qty + item.shortage_qty) }}
                                </td>
                            </tr>
                            <tr ng-show="!items">
                                <td colspan="11"><code>No stock available in this van!</code></td>
                            </tr>
                            </tbody>
                        </table>
                    </div>
...
<div class="row" ng-show="!location && !loading">
    <div class="col-md-12">
        <span class="text-muted">Please choose a van to generate the stock report</span>
    </div>
</div>