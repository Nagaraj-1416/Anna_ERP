                    ...
                    <ul class="list-style-none">
                        ...
                        <li>
                            <div class="ui fluid  search selection dropdown store-drop-down">
                                ...
                                <div class="menu">
                                    @foreach(returnStoreDropDown() as $key => $store)
                    ...
                    <div class="right-page-header">
                        <div class="d-flex m-b-10">
                            <div class="align-self-center">
                                <h2 class="card-title m-t-10">Returned Stocks @{{ total ? ("(" + total +")") :
                                    '' }}</h2>
                            </div>
                    ...
                    <div class="row" ng-hide="loading" ng-if="stocks.length === 0 && filterd">
                        <div class="col-md-12">
                            <div class="card text-center">
                                <div class="card-body">
                                    <p class="card-text">There are <code>no</code> returned stocks found.</p>
                                </div>
                            </div>
                        </div>
                    </div>
...
@section('script')
    <script>
        app.controller('StockController', ['$scope', '$http', function ($scope, $http) {
            var moduleRoute = '{{ route('stock.return.index') }}';
            $scope.stocks = [];
            $scope.filterd = false;
            $scope.loading = true;
            $scope.pagination = {};
