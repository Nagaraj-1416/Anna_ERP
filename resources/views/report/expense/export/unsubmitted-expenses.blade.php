...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Unsubmitted Expense' }}</title>
...
<div style="font-family: sans-serif;font-size: 12px;" id="purchase_by_supplier">
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">Unsubmitted Expense</span>
                </td>
            </tr>
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
    ...
    <div>
        @include('report.expense.export._inc.table')
    </div>
</div>
</body>
</html>