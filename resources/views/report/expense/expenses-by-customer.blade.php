...
@section('title', 'Expenses by Customer')
@section('breadcrumbs')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Expenses by Customer</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                            ...
                            <div class="row">
                                <div class="col-md-3">
                                    <div class="form-group {{ $errors->has('customer') ? 'has-danger' : '' }}">
                                        <label class="control-label">Expenses Customer</label>
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Expenses by Customer</b></h2>
...
@section('script')
    ...
    <script>
        app.controller('SalesRepController', ['$scope', '$http', function ($scope, $http) {
            var customers = @json(\App\Customer::all()->toArray());
            $scope.loading = true;
            $scope.expenses = [];
            $scope.total = 0;
            $scope.length = 0;
            ...
            $scope.generate = function () {
                ...
                $scope.loading = true;
                var orderRoute = '{{ route('report.expense.by.customer') }}';
            ...
            $scope.getCustomer = function (key) {
                var object = _.find(customers, function (value, index) {
            ...
            $scope.getExportRoute = function () {
                var route = '{{ route('report.expense.by.customer.export') }}';
