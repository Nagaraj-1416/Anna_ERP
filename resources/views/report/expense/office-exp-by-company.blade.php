...
@section('title', 'Office Expenses by Company')
@section('breadcrumbs')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Office Expenses by Company</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
    ...
    <script>
        app.controller('ExpenseController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.generate = function () {
                ...
                $scope.loading = true;
                var expenseRoute = '{{ route('report.expense.office.by.company') }}';
