...
@endsection
@section('content')
    <section ng-controller="StockReportController">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Stock Ledger</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Stock Ledger</b></h2>
...
@section('script')
    ...
    <script>
        app.controller('StockReportController', ['$scope', '$http', function ($scope, $http) {
            $scope.query = {
                fromDate: '',
                toDate: '',
                businessType: null,
            ...
            $scope.dropdowns.customer.dropdown('setting', {
                ...
                saveRemoteData: false,
                apiSettings: {
                    url: '{{ route('sales.customer.search') }}' + '/{query}',
                    cash: false,
                },
                onChange: function (val, name) {
