...
@section('title', 'Damages by Route')
@section('breadcrumbs')
    {!! breadcrumbRender($breadcrumb, 'Reports') !!}
@endsection
@section('content')
    <section ng-controller="DamagedRouteController">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Damages by Route</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Damages by Route</b></h2>
...
@section('script')
    ...
    <script>
        app.controller('DamagedRouteController', ['$scope', '$http', function ($scope, $http) {
            $scope.query = {
                fromDate: '',
                toDate: '',
                company: '',
            ...
            $scope.generate = function () {
                ...
                $scope.loading = true;
                var orderRoute = '{{ route('report.damage.by.route') }}';
