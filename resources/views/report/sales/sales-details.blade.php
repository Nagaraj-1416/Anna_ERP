            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Sales Order Details</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Sales Order Details</b></h2>
    ...
    <script>
        app.controller('salesProductController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.getExportRoute = function () {
                var route = '{{ route('report.sales.order.details.export') }}';
