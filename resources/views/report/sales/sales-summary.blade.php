...
@endsection
@section('content')
    <section ng-controller="SalesSummaryController">
        <div class="row">
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Sales Summary</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Sales Summary</b></h2>
        ...
        <div id="order-sidebar" class="card card-outline-inverse disabled-dev" style="border: none !important;">
            ...
            <div class="card-header ">
                <h3 class="m-b-0 text-white">Sales Summary</h3>
            ...
            <div class="card-body" id="order-sidebar-body">
                <div class="row">
                    <div class="col-md-12">
                        <table class="ui celled structured table collapse-table">
                            ...
                            <tbody>
                                <tr ng-repeat="orderItem in orderList" ng-if="orderList.length">
                                    ...
                                    <td class="text-center @{{ orderItem.status == 'Closed' ? 'text-green' : 'text-warning' }}">@{{ orderItem.status }}</td>
                                ...
                                <tr ng-if="orderList.length">
                                    <td colspan="5" class="table-primary text-right"><b>Total</b></td>
                        ...
                        {{--<hr>--}}
                        {{--<button type="button" class="btn pull-right btn-inverse waves-effect waves-light"--}}
        ...
        <div id="products-sidebar" class="card card-outline-inverse disabled-dev" style="border: none !important;">
            ...
            <div class="card-header ">
                ...
                <h6 class="card-subtitle text-white"></h6>
            </div>
...
@section('script')
    ...
    <script>
        app.controller('SalesSummaryController', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
            $scope.query = {
                fromDate: '',
                toDate: '',
                // company_id : null
            ...
            $scope.generate = function () {
                ...
                $scope.loading = true;
                var orderRoute = '{{ route('report.sales.summary') }}';
            ...
            $scope.resetFilters = function () {
                ...
                dateRangeDropDown($scope);
                $scope.el.companyDropDown.dropdown('clear');
                $scope.generate();
            };
            ...
            $scope.showProducts = function(order) {
                ...
                var productListRoute = '{{ route('report.sales.summary.product.list') }}';
            ...
            $scope.showOrders = function(order) {
                ...
                $scope.openSideBar();
                $scope.showLoader();
                var orderListRoute = '{{ route('report.sales.summary.list') }}';
