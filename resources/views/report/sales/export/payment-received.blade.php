...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Payment Received' }}</title>
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">Payment Received</span>
                </td>
            </tr>
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
    ...
    <div>
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;font-size: 12px;">
            ...
            <tr style="background-color: #2f3d4a;">
                <th style="height: 35px;color: #fff;text-align: left;width: 15%;padding-left: 10px;">INVOICE#</th>
                ...
                <th style="text-align: left;color: #fff;width: 15%;">DEPOSIT TO</th>
                ...
                @foreach($payments as $key => $values)
                    <tr>
                        <td style="padding-left: 10px; padding-top: 10px;" colspan="7">
                            <b>{{ \App\Customer::find($key)->display_name ?? 'None' }}</b></td>
                    </tr>
                    <tr>
                        <td colspan="7">
                            <hr>
                    ...
                    @foreach($values as $paymentKey => $payment)
                        <tr>
                            ...
                            <td style="vertical-align: middle;text-align: left;width: 15%;">{{ $payment->depositeTo->name ?? 'None' }}</td>
