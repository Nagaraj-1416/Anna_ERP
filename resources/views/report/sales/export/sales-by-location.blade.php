...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Sales by Sales Location' }}</title>
...
<div style="font-family: sans-serif;font-size: 12px;" id="sales_by_customer">
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">Sales by Sales Location</span>
                </td>
            </tr>
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
    ...
    @if(isset($orders))
        @include('report.sales.export._inc.grouped-table', ['model' => new \App\SalesLocation(), 'get' => 'name'])
    @endif
</div>
</body>
</html>