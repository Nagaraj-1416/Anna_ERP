...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Sales by Rep' }}</title>
    <meta charset="iso-8859-1">
</head>
<body>
<!-- pdf full panel -->
<div style="font-family: sans-serif;font-size: 12px;" id="sales_by_rep">
    <div>
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">Sales by Rep</span>
                </td>
            </tr>
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
    ...
    @if(isset($orders))
        @include('report.sales.export._inc.grouped-table', ['model' => new \App\Rep(), 'get' => 'name'])
    @endif
</div>
</body>
</html>