...
@section('title', 'Purchase by Product')
@section('breadcrumbs')
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Purchase by Product</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
    ...
    <script>
        app.controller('purchaseProductController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.getProduct = function (id) {
                var name = _.find($scope.products, function (value, key) {
            ...
            $scope.getExportRoute = function () {
                var route = '{{ route('report.purchase.by.product.export') }}';
