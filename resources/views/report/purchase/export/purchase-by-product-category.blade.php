...
<head>
    ...
    <title>{{ env('APP_NAME') }} | {{ 'Purchase by Product Category' }}</title>
...
<div style="font-family: sans-serif;font-size: 12px;" id="purchase_by_supplier">
        ...
        <table style="font-family: sans-serif;width: 100%;border-collapse: collapse;">
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
                    <span style="font-weight: 700;color: #455a64;font-size: 22px;font-family: sans-serif;">Purchase by Product Category</span>
                </td>
            </tr>
            <tr>
                <td style="width: 50%;font-family: sans-serif;" align="center">
    ...
    @if(isset($orders))
        @include('report.purchase.export._inc.table')
    @endif
</div>
</body>
</html>