...
@section('title', 'Credits by Route')
@section('breadcrumbs')
...
@section('content')
    <section ng-controller="CreditSummaryController">
            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Credits by Route</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Credits by Route</b></h2>
        ...
        <div id="order-sidebar" class="card card-outline-inverse disabled-dev" style="border: none !important;">
            ...
            <div class="card-body" id="order-sidebar-body" style="overflow-y: auto; height: 100px; float:left;">
                <div class="row">
                    <div class="col-md-12">
                        <table class="ui celled structured table collapse-table">
                            ...
                            <tbody>
                                ...
                                <tr ng-if="orderList.length">
                                    <td colspan="5" class="table-info text-right"><b>TOTAL</b></td>
    ...
    <script>
        app.controller('CreditSummaryController', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
            ...
            $scope.generate = function () {
                $scope.loading = true;
                var orderRoute = '{{ route('report.credits.by.route') }}';
