            ...
            <div class="col-md-12">
                <div class="card">
                    <div class="card-body p-b-0">
                        <h3 class="card-title"><i class="ti-bar-chart"></i> Credits by Rep</h3>
                    </div>
                    <hr>
                    <div class="card-body">
                        <!-- from to filter -->
                        ...
                        <div class="heading-section">
                            <h2 class="text-center"><b>Credits by Rep</b></h2>
    ...
    <script>
        app.controller('CreditSummaryController', ['$scope', '$http', '$filter', function ($scope, $http, $filter) {
            ...
            $scope.generate = function () {
                $scope.loading = true;
                var orderRoute = '{{ route('report.credits.by.rep') }}';
