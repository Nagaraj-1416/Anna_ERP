        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body p-b-0">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h3 class="card-title"><i class="ti-receipt"></i> Cash Book - Rep</h3>
                            <h6 class="card-subtitle">
                                A <code>rep</code> & <code>date range</code> filters are required to generate this Cash Book!
                            </h6>
                        </div>
                ...
                <div class="card-body" ng-show="!loading">
                    ...
                    <div class="row" ng-show="!rep && !loading">
                        <div class="col-md-12">
                            <hr>
                            <span class="text-muted">Please choose a rep to generate the cash book report!</span>
                        </div>
                    </div>
                </div>
            </div>
