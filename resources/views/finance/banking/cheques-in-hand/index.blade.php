        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-body p-b-0">
                    <div class="clearfix">
                        <div class="pull-left">
                            <h3 class="card-title"><i class="ti-receipt"></i> Cheques in Hand</h3>
                ...
                <div class="card-body p-b-5">
                    <div class="form-filter">
                        ...
                        <div class="row m-b-15">
                            ...
                            <div class="col-md-3">
                                <div class="form-group">
                                    <label class="control-label">Cheque transferred?</label>
                                    <div class="ui fluid  search selection dropdown transferred-drop-down">
                                        <input type="hidden" name="is_transferred">
                                        <i class="dropdown icon"></i>
                                        <div class="default text">choose an option</div>
                                        <div class="menu">
                                            @foreach(chequeTransferred() as $key => $trans)
                                                <div class="item" data-value="{{ $key }}">{{ $trans }}</div>
                                            @endforeach
                                        </div>
                                    </div>
                                </div>
                    ...
                    <table class="ui celled structured table collapse-table">
                        ...
                        <tbody>
                            <tr ng-repeat="(key, chequesData) in cheques" ng-show="length">
                                ...
                                <td>
                                    <table ng-if="chequesData.length != 0" width="100%" class="table custom-table">
                                        <tbody>
                                            <tr ng-repeat="cheque in chequesData">
                                                <td width="85%">
                                                    <div ng-if="cheque.type == 'Auto'">
                                                        ...
                                                        <a target="_blank" href="/sales/invoice/@{{ cheque.chequeable.invoice_id }}">
                                                            @{{ cheque.chequeable.invoice.ref }}
                                                        </a>
                                                    </div>
                                                    <div ng-if="cheque.type == 'Manual'">
                                                        <p>Cheque registered manually</p>
                                                    </div>
                                                </td>
                                                <td class="text-right" style="border-right: none;">
                                                    <div ng-if="cheque.type == 'Auto'">
                                                        @{{ cheque.chequeable.payment | number:2 }}
                                                    </div>
                                                    <div ng-if="cheque.type == 'Manual'">
                                                        @{{ cheque.amount | number:2 }}
                                                    </div>
                                                </td>
                                            </tr>
                                        </tbody>
    ...
    <script>
        app.controller('ChequesInHandController', ['$scope', '$http', function ($scope, $http) {
            ...
            $scope.generate = function () {
                ...
                $scope.loading = true;
                var orderRoute = '{{ route('finance.cheques.hand.index') }}';
