...
@section('breadcrumbs')
    {!! breadcrumbRender($breadcrumb, 'Transactions') !!}
@endsection
@section('content')
<div class="row" ng-controller="TransController">
    <div class="col-12">
        <div class="card">
            ...
            <div class="contact-page-aside">
                ...
                <div class="left-aside">
                    <a target="_blank" href="{{ route('finance.trans.create') }}" class="btn btn-info btn-block">
                    ...
                    <ul class="list-style-none">
                        ...
                        <li ng-class="{'active': query.filter === 'Deposit'}"
                            ng-click="filterUpdate('Deposit')"><a href="">Deposit Transactions</a></li>
                        <li ng-class="{'active': query.filter === 'Withdrawal'}"
                            ng-click="filterUpdate('Withdrawal')"><a href="">Withdrawal Transactions</a></li>
                        <li ng-class="{'active': query.filter === 'Auto'}"
                            ng-click="filterUpdate('Auto')"><a href="">Auto Transactions</a></li>
                        <li ng-class="{'active': query.filter === 'Manual'}"
                            ng-click="filterUpdate('Manual')"><a href="">Manual Transactions</a></li>
                    </ul>
                    <hr>
                    <ul class="list-style-none">
                ...
                <div class="right-aside custom-right-aside">
                    <div class="right-page-header">
                        <div class="d-flex m-b-10">
                            ...
                            <div class="ml-auto">
                                <input type="text" id="demo-input-search2" ng-model="searchTrans"
                                       placeholder="search for transaction here" class="form-control"
                            ...
                            <table class="table m-t-10 table-hover no-wrap contact-list">
                                ...
                                <tbody class="text-muted">
                                    <tr ng-repeat="tran in trans">
                                        <td>
                                            <a target="_blank" href="transaction/@{{ tran.id }}">
                                                @{{ tran.date | date }}
                                            </a>
                                            <br />
                                            ...
                                            <small class="text-muted"><b>Trans.No </b>#@{{ tran.code }}</small>
                                        </td>
                                        <td class="text-right">@{{ tran.amount | number: 2 }}<br />
                                            <small class="text-muted">@{{ tran.type }} (@{{ tran.category }})</small><br />
                                            <small class="text-muted">@{{ tran.txType.name }}</small>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
                    ...
                    <div class="row" ng-hide="loading" ng-if="trans.length === 0 && !filterd">
                        <div class="col-md-12">
                            <div class="card text-center">
                                <div class="card-body">
                                    <p class="card-text">You haven't added any transactions yet, click on "Add New
                                        Transaction" button to add transaction.</p>
                                    <a target="_blank" href="{{ route('finance.trans.create') }}"
                                       class="btn btn-info">
                                        <i class="fa fa-plus"></i> Add New Transaction
                                    </a>
                                </div>
...
@section('script')
    <script>
        app.controller('TransController', ['$scope', '$http', function ($scope, $http) {
            var moduleRoute = '{{ route('finance.trans.index') }}';
            $scope.trans = [];
            $scope.filterd = false;
            $scope.loading = true;
            $scope.pagination = {};
