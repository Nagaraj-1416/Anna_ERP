...
/**
 * Class SalesLocationPolicy
 * @package App\Policies\Settings
 * @property bool $check
 * @property array $replace
 * @property array $policies
 * @property SalesLocation $model
 */
class SalesLocationPolicy extends  Policy
{
    /**
    ...
    /**
     * @var SalesLocation $model The attributes that are related model class .
     */
    public $model = SalesLocation::class;
