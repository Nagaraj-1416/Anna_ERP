...
/**
 * Class ProductionUnitPolicy
 * @package App\Policies\Settings
 * @property bool $check
 * @property array $replace
 * @property array $policies
 * @property ProductionUnit $model
 */
class ProductionUnitPolicy extends  Policy
{
    /**
    ...
    /**
     * @var ProductionUnit $model The attributes that are related model class .
     */
    public $model = ProductionUnit::class;
