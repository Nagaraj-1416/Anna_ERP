 ...
 * @property VehicleMake $model
 */
class VehicleMakePolicy extends Policy
{
    ...
    /**
     * @var VehicleMake $model The attributes that are related model class .
     */
    public $model = VehicleMake::class;
