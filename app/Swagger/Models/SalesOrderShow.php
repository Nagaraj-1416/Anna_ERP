...
/**
 * @SWG\Definition(type="object", @SWG\Xml(name="SalesOrderShow"))
 */
...
class SalesOrderShow
{
     ...
     * @SWG\Property(
     *     format="float",
     *     title="customer's outstanding amount",
     *     description="customer's outstanding amount",
     * )
     * @var float
     */
    public $customer_outstanding;
     ...
     * @SWG\Property(
     *     format="array",
     *     title="sales order invoices",
     *     description="sales order invoices",
     *     type="array",
     *     @SWG\Items(
     ...
     * @SWG\Property(
     *     format="array",
     *     title="sales order invoices payments",
     *     description="sales order invoices, payments",
     *     type="array",
     *     @SWG\Items(
