...
/**
 * @SWG\Definition(type="object", @SWG\Xml(name="EstimateShow"))
 */
...
class EstimateShow
{
     ...
     * @SWG\Property(
     *     format="array",
     *     title="Estimation rep",
     *     description="Estimation rep",
     *     type="array",
     *     @SWG\Items(
     *         ref="#/definitions/Rep"
     *      )
     ...
     * @SWG\Property(
     *     format="array",
     *     title="Estimation prepared by",
     *     description="Estimation prepared by",
     *     type="array",
     *     @SWG\Items(
     ...
     * @SWG\Property(
     *     format="array",
     *     title="Estimation customer",
     *     description="Estimation customer",
     *     type="array",
     *     @SWG\Items(
