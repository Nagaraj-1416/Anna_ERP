...
class CreditRefundRequest extends FormRequest
{
    ...
    public function rules()
    {
         ...
         * @var SupplierCreditRefund $refund
         */
     ...
     * @return float
     */
    protected function getPendingCreditAmountForUpdate(SupplierCreditRefund $refund)
    {
     ...
     * @return float
     */
    public function getCreditAmount(SupplierCredit $credit)
    {
