...
class ExpenseReceiptStoreRequest extends FormRequest
{
    /**
    ...
    public function rules()
    {
        ...
        if ($this->input('expense_mode') == 'ForOthers') {
            $rules['expense_category'] = 'required';
        }

        if ($this->input('expense_mode') == 'ForOthers' && $this->input('expense_category') == 'Office') {
            $rules['branch_id'] = 'required';
        }

        if ($this->input('expense_mode') == 'ForOthers' && $this->input('expense_category') == 'Shop') {
